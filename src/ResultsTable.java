...
public class ResultsTable extends JTable {
    ...
    private static String[] columnNames = { "Rank", "Country", "Number of Sites",
    ...
    public void fillTable(int topN, ArrayList<Country> sortedCountries, boolean topTable) {
        ...
        if (topTable) {
            ...
            for (int i = 0; i < topN; i++) {
                ...
                data[i][4] = sortedCountries.get(i).getMonthTemperature() + " F";
            ...
            for (int i = indexOfWorstCountry; i > indexOfWorstCountry - topN; i--) {
                ...
                data[indexOfWorstCountry - i][4] = sortedCountries.get(i).getMonthTemperature() + " F"; 
